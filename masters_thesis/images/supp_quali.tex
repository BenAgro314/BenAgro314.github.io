\begin{figure*}
    ...
    \begin{tikzpicture}
        ...
        % images are 1600 x 1600
        \node[draw=black,very thick,anchor=north , inner sep=0pt]  (S1B) at (0, 0) {\includegraphics[width=\imw, viewport=216 7 792 583, clip]{images/images_for_supp/66/original_det_anchors_wod_viz_66_126.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt] (S1C) at (S1B.east)  {\includegraphics[width=\imw, viewport=216 7 792 583, clip]{images/images_for_supp/66/interpolated_det_anchors_wod_viz_66_126.pdf}};
        \node[draw=black,very thick,anchor=west, inner sep=0pt] (S1A) at (S1C.east)     {\includegraphics[width=\imw, viewport=216 7 792 583, clip]{images/images_for_supp/66/lidar_proposals_wod_viz_66_126.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt] (S1D) at (S1A.east)  {\includegraphics[width=\imw, viewport=216 7 792 583, clip]{images/images_for_supp/66/detections_wod_viz_66_126.pdf}};
    
        \node at (S1A.north) [anchor=south] {\footnotesize Detection Proposal Boxes $\mathbf{B}^\mathrm{det}$};
        \node at (S1B.north) [anchor=south] {\footnotesize Memory Bank};
        \node at (S1C.north) [anchor=south] {\footnotesize Memory Proposal Boxes $\mathbf{B}^\mathrm{mem}$};
        \node at (S1D.north) [anchor=south] {\footnotesize \ourmodel{} Output Boxes $\mathbf{B}^\mathrm{ref}$};
    
        \node[draw=black,very thick,anchor=north , inner sep=0pt]  (S2B) at ([yshift=-\rowsep]S1B.south)                   {\includegraphics[width=\imw, viewport=14 432 518 936, clip]{images/images_for_supp/98/original_det_anchors_wod_viz_98_138.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S2C) at (S2B.east)                   {\includegraphics[width=\imw, viewport=14 432 518 936, clip]{images/images_for_supp/98/interpolated_det_anchors_wod_viz_98_138.pdf}};
        \node[draw=black,very thick,anchor=west, inner sep=0pt] (S2A) at (S2C.east) {\includegraphics[width=\imw, viewport=14 432 518 936, clip]{images/images_for_supp/98/lidar_proposals_wod_viz_98_138.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S2D) at (S2A.east)                   {\includegraphics[width=\imw, viewport=14 432 518 936, clip]{images/images_for_supp/98/detections_wod_viz_98_138.pdf}};

                                                                                                                              % 72 288 936 1152
        \node[draw=black,very thick,anchor=north , inner sep=0pt]  (S3B) at ([yshift=-\rowsep]S2B.south)                   {\includegraphics[width=\imw, viewport=72 288 936 1152, clip]{images/images_for_supp/64/original_det_anchors_wod_viz_64_90.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S3C) at (S3B.east)                   {\includegraphics[width=\imw, viewport=72 288 936 1152, clip]{images/images_for_supp/64/interpolated_det_anchors_wod_viz_64_90.pdf}};
        \node[draw=black,very thick,anchor=west, inner sep=0pt]  (S3A) at (S3C.east) {\includegraphics[width=\imw, viewport=72 288 936 1152, clip]{images/images_for_supp/64/lidar_proposals_wod_viz_64_90.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S3D) at (S3A.east)                   {\includegraphics[width=\imw, viewport=72 288 936 1152, clip]{images/images_for_supp/64/detections_wod_viz_64_90.pdf}};

        \node[draw=black,very thick,anchor=north , inner sep=0pt]  (S4B) at ([yshift=-\rowsep]S3B.south)                   {\includegraphics[width=\imw, viewport=144 144 936 936, clip]{images/images_for_supp/73/original_det_anchors_wod_viz_73_126.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S4C) at (S4B.east)                   {\includegraphics[width=\imw, viewport=144 144 936 936, clip]{images/images_for_supp/73/interpolated_det_anchors_wod_viz_73_126.pdf}};
        \node[draw=black,very thick,anchor=west, inner sep=0pt] (S4A) at (S4C.east) {\includegraphics[width=\imw, viewport=144 144 936 936, clip]{images/images_for_supp/73/lidar_proposals_wod_viz_73_126.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S4D) at (S4A.east)                   {\includegraphics[width=\imw, viewport=144 144 936 936, clip]{images/images_for_supp/73/detections_wod_viz_73_126.pdf}};
    
        % Labels for rows (Scenes)
        \node[anchor=south,rotate=90] at (S1B.west) {\footnotesize Scene \#1};
        \node[anchor=south,rotate=90] at (S2B.west) {\footnotesize Scene \#2};
        \node[anchor=south,rotate=90] at (S3B.west) {\footnotesize Scene \#3};
        \node[anchor=south,rotate=90] at (S4B.west) {\footnotesize Scene \#4};
        ...
        % annotations
        \node[circle, draw=green, minimum size=0.22*\imw*2, inner sep=0pt, anchor=center, dashed] (a1) at (S1A.center) [xshift=-0.00*\imw, yshift=-0.14*\imw] {};
        \node[circle, fill=green, minimum size=0.05*\imw, inner sep=0pt] at (a1.-45) {\scriptsize{a}};
        \node[circle, draw=green, minimum size=0.22*\imw*2, inner sep=0pt, anchor=center, dashed] (a1b) at (S1D.center) [xshift=-0.00*\imw, yshift=-0.14*\imw] {};
        \node[circle, fill=green, minimum size=0.05*\imw, inner sep=0pt] at (a1b.-45) {\scriptsize{a}};

        \node[circle, draw=green, minimum size=0.17*\imw*2, inner sep=0pt, anchor=center, dashed] (a2) at (S2A.center) [xshift=-0.16*\imw, yshift=0.33*\imw] {};
        \node[circle, fill=green, minimum size=0.05*\imw, inner sep=0pt] at (a2.-45) {\scriptsize{a}};
        \node[circle, draw=green, minimum size=0.17*\imw*2, inner sep=0pt, anchor=center, dashed] (a2b) at (S2D.center) [xshift=-0.16*\imw, yshift=0.33*\imw] {};
