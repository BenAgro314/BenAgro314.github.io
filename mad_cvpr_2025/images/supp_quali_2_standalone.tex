...
\newcommand{\ourmodel}{MAD}
    \begin{tikzpicture}
        ...
        % are 1152 x 1152
        \node[draw=black,very thick,anchor=north, inner sep=0pt] (S5A) at (0, 0)     {\includegraphics[width=\imw,  viewport=396 216 1008 828, clip]{images_for_supp/31/lidar_proposals_wod_viz_31_198.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S5B) at (S5A.east) {\includegraphics[width=\imw, viewport=396 216 1008 828, clip]{images_for_supp/31/original_det_anchors_wod_viz_31_198.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt] (S5C) at (S5B.east)  {\includegraphics[width=\imw, viewport=396 216 1008 828, clip]{images_for_supp/31/interpolated_det_anchors_wod_viz_31_198.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt] (S5D) at (S5C.east)  {\includegraphics[width=\imw, viewport=396 216 1008 828, clip]{images_for_supp/31/detections_wod_viz_31_198.pdf}};
    
        % \node at (S5A.north) [anchor=south] {\small Detection Proposal Boxes $\mathbf{B}^\mathrm{det}$};
        % \node at (S5B.north) [anchor=south] {\small Memory Bank};
        % \node at (S5C.north) [anchor=south] {\small Memory Proposal Boxes $\mathbf{B}^\mathrm{mem}$};
        % \node at (S5D.north) [anchor=south] {\small \ourmodel{} Output Boxes $\mathbf{B}^\mathrm{ref}$};
    
        \node[draw=black,very thick,anchor=north, inner sep=0pt] (S6A) at ([yshift=-\rowsep]S5A.south) {\includegraphics[width=\imw, viewport= 10 270 480 740, clip] {images_for_supp/82/lidar_proposals_wod_viz_82_120.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S6B) at (S6A.east)                   {\includegraphics[width=\imw, viewport=10 270 480 740, clip]{images_for_supp/82/original_det_anchors_wod_viz_82_120.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S6C) at (S6B.east)                   {\includegraphics[width=\imw, viewport=10 270 480 740, clip]{images_for_supp/82/interpolated_det_anchors_wod_viz_82_120.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S6D) at (S6C.east)                   {\includegraphics[width=\imw, viewport=10 270 480 740, clip]{images_for_supp/82/detections_wod_viz_82_120.pdf}};

        %                                                                                                                       % 72 288 936 1152
        \node[draw=black,very thick,anchor=north, inner sep=0pt] (S7A) at ([yshift=-\rowsep]S6A.south) {\includegraphics[width=\imw,  viewport=72 72 790 790, clip]{images_for_supp/91/lidar_proposals_wod_viz_91_144.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S7B) at (S7A.east)                   {\includegraphics[width=\imw, viewport=72 72 790 790, clip]{images_for_supp/91/original_det_anchors_wod_viz_91_144.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S7C) at (S7B.east)                   {\includegraphics[width=\imw, viewport=72 72 790 790, clip]{images_for_supp/91/interpolated_det_anchors_wod_viz_91_144.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S7D) at (S7C.east)                   {\includegraphics[width=\imw, viewport=72 72 790 790, clip]{images_for_supp/91/detections_wod_viz_91_144.pdf}};

        \node[draw=black,very thick,anchor=north , inner sep=0pt]  (S8B) at ([yshift=-\rowsep]S7A.south)                   {\includegraphics[width=\imw, viewport=50 360 820 1130, clip]{images_for_supp/161/original_det_anchors_wod_viz_161_138.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S8C) at (S8B.east)                   {\includegraphics[width=\imw, viewport=50 360 820 1130, clip]{images_for_supp/161/interpolated_det_anchors_wod_viz_161_138.pdf}};
        \node[draw=black,very thick,anchor=west, inner sep=0pt] (S8A) at (S8C.east) {\includegraphics[width=\imw,  viewport=50 360 820 1130, clip]{images_for_supp/161/lidar_proposals_wod_viz_161_138.pdf}};
        \node[draw=black,very thick,anchor=west , inner sep=0pt]  (S8D) at (S8A.east)                   {\includegraphics[width=\imw, viewport=50 360 820 1130, clip]{images_for_supp/161/detections_wod_viz_161_138.pdf}};
    
        % Labels for rows (Scenes)
        % \node[anchor=south,rotate=90] at (S5A.west) {Scene \#5};
        % \node[anchor=south,rotate=90] at (S6A.west) {Scene \#6};
        % \node[anchor=south,rotate=90] at (S7A.west) {Scene \#7};
        % \node[anchor=south,rotate=90] at (S8A.west) {Scene \#8};

        % colormap
        % \node[inner sep=0pt,anchor=north] (cmap) at ($(S5B.north)+(0,-0.2em)$)
        %     {\includegraphics[width=0.22\textwidth, height=0.8em, trim={2mm, 2mm, 2mm, 2mm}, clip, angle=180]{images_for_hook_light/cool_colormap.png}};
        ...
        % annotations
        \node[circle, draw=green, minimum size=0.33*\imw*2, inner sep=0pt, anchor=center, dashed] (a4) at (S5A.center) [xshift=-0.17*\imw, yshift=-0.08*\imw] {};
        ...
        \node[circle, draw=green, minimum size=0.33*\imw*2, inner sep=0pt, anchor=center, dashed] (a4b) at (S5D.center) [xshift=-0.17*\imw, yshift=-0.08*\imw] {};
        ...
        \node[circle, draw=green, minimum size=0.45*\imw*2, inner sep=0pt, anchor=center, dashed] (b4) at (S6A.center) [xshift=-0.05*\imw, yshift=0.0*\imw] {};
        \node[circle, fill=green, minimum size=0.05*\imw, inner sep=0pt] at (b4.-45) {\scriptsize{b}};
        \node[circle, draw=green, minimum size=0.45*\imw*2, inner sep=0pt, anchor=center, dashed] (b4b) at (S6D.center) [xshift=-0.05*\imw, yshift=0.0*\imw] {};
